 ...
 * @update      2025-06-30
 * 
 * @product     iQ ISD (iQ Thermostat)
 * 
 * @firmware    iQ ISD firmware version >= 1.0
 * 
 */
...
var VERSION_CONTROL = {
    ...
    DEVICE: {MODEL : "ISD Lite", NAME: "genericModel"},
    PRODUCT: {CODE : "P1002032", NAME: "productCode"},
...
var DEVICE_GENERIC_REGISTERS = {
    ...
    "0x6D" : {SIZE : 1, NAME : "batteryVoltage", RESOLUTION: 0.1},
...
var DEVICE_SPECIFIC_REGISTERS = {
    "0x02" : {SIZE: 2, NAME : "temperature", RESOLUTION: 0.01, SIGNED: true},
    "0x03" : {SIZE: 2, NAME : "humidity", RESOLUTION: 0.01},


    "0x12" : {SIZE: 2, NAME : "temperatureInterval"},
    "0x13" : {SIZE: 2, NAME : "HumidityInterval"},

    "0x22" : {SIZE: 2, NAME : "temperatureCorrection", RESOLUTION: 0.01, SIGNED: true},
    "0x23" : {SIZE: 2, NAME : "HumidityCorrection", RESOLUTION: 0.01, SIGNED: true},
    ...
    "0xE0" : {SIZE: 2, NAME : "defaultSetpointHeating", RESOLUTION: 0.01, SIGNED: true},
    "0xE1" : {SIZE: 2, NAME : "defaultSetpointCooling", RESOLUTION: 0.01, SIGNED: true},
    "0xE2" : {SIZE: 2, NAME : "setpoint", RESOLUTION: 0.01, SIGNED: true},
    "0xE3" : {SIZE: 1, NAME : "setpointMode", VALUES: {"0x00" : "heating", "0x01" : "cooling",}},
    "0xE4" : {SIZE: 1, NAME : "setpointDailyResetFunction", VALUES: {"0x00" : "disabled", "0x01" : "enabled",}},
    "0xE5" : {SIZE: 2, NAME : "setpointDailyResetTimeInMinutes"},
    "0xE6" : {SIZE: 2, NAME : "setpointStepValue", RESOLUTION: 0.01, SIGNED: true},


    "0xB0" : {SIZE: 4, NAME : "pushCounterButtonB1",},
    "0xB1" : {SIZE: 4, NAME : "lastPushTimestampButtonB1",},
    "0xB2" : {SIZE: 4, NAME : "pushCounterButtonB2",},
    "0xB3" : {SIZE: 4, NAME : "lastPushTimestampButtonB2",},
    "0xB4" : {SIZE: 4, NAME : "pushCounterButtonB3",},
    "0xB5" : {SIZE: 4, NAME : "lastPushTimestampButtonB3",},
    "0xB6" : {SIZE: 2, NAME : "setpointConfigurationDelayInMs",},
    "0xBC" : {SIZE: 1, NAME : "buzzerFunction", VALUES: {"0x00" : "disabled", "0x01" : "enabled",}},
    "0xBD" : {SIZE: 2, NAME : "buzzerDurationInMs",},
    "0xBE" : {SIZE: 1, NAME : "boilerWatchdogAlarm", VALUES: {"0x00" : "normal", "0x01" : "alarm",}},
};
